...
from .records import _SKIP_JOBRAD_VIEWS_DEFAULT, _remove_import_export_paths, _rm_refs, remove_records, remove_view, replace_record_references_batch
...
def remove_model(cr, model, drop_table=True, ignore_m2m=(), skip_jobrad_custom_contract_views=_SKIP_JOBRAD_VIEWS_DEFAULT):
    """
